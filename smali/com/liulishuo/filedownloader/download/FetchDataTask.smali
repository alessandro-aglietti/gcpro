...
.method private sync()V
    ...
    .line 238
    iget-object v4, p0, Lcom/liulishuo/filedownloader/download/FetchDataTask;->database:Lcom/liulishuo/filedownloader/database/FileDownloadDatabase;

    iget v5, p0, Lcom/liulishuo/filedownloader/download/FetchDataTask;->downloadId:I

    iget v6, p0, Lcom/liulishuo/filedownloader/download/FetchDataTask;->connectionIndex:I
...
.method public run()V
    ...
    iget-wide v12, v1, Lcom/liulishuo/filedownloader/download/FetchDataTask;->contentLength:J
    ...
    invoke-interface {v15, v4, v5}, Lcom/liulishuo/filedownloader/stream/FileDownloadOutputStream;->seek(J)V
    ...
    iget-wide v6, v1, Lcom/liulishuo/filedownloader/download/FetchDataTask;->startOffset:J
    ...
    iget-wide v5, v1, Lcom/liulishuo/filedownloader/download/FetchDataTask;->endOffset:J
    ...
    .line 138
    iget-boolean v5, v1, Lcom/liulishuo/filedownloader/download/FetchDataTask;->paused:Z
    :try_end_2
    ...
    .line 179
    :try_start_5
    invoke-interface {v15}, Lcom/liulishuo/filedownloader/stream/FileDownloadOutputStream;->close()V
    :try_end_5
    ...
    .line 191
    invoke-static {v2, v6}, Lcom/liulishuo/filedownloader/util/FileDownloadUtils;->formatString(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 146
    :try_start_c
    invoke-interface {v15, v0, v10, v5}, Lcom/liulishuo/filedownloader/stream/FileDownloadOutputStream;->write([BII)V
    ...
    iput-wide v6, v1, Lcom/liulishuo/filedownloader/download/FetchDataTask;->currentOffset:J

    .line 151
    iget-object v5, v1, Lcom/liulishuo/filedownloader/download/FetchDataTask;->callback:Lcom/liulishuo/filedownloader/download/ProcessCallback;

    invoke-interface {v5, v11, v12}, Lcom/liulishuo/filedownloader/download/ProcessCallback;->onProgress(J)V
    ...
    :cond_18
    :try_start_11
    iget-boolean v5, v1, Lcom/liulishuo/filedownloader/download/FetchDataTask;->isWifiRequired:Z
