...
.method private fetchWithMultipleConnection(Ljava/util/List;J)V
    ...
    const-string v11, "pass connection[%d-%d], because it has been completed"
    ...
    .line 696
    invoke-static {v0, v11, v12}, Lcom/liulishuo/filedownloader/util/FileDownloadLog;->d(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 705
    invoke-static/range {v20 .. v27}, Lcom/liulishuo/filedownloader/download/ConnectionProfile$ConnectionProfileBuild;->buildConnectionProfile(JJJJ)Lcom/liulishuo/filedownloader/download/ConnectionProfile;
    ...
    .line 754
    invoke-static {v0, v4, v6}, Lcom/liulishuo/filedownloader/util/FileDownloadLog;->d(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private trialConnect()V
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable;->handleTrialConnectResult(Ljava/util/Map;Lcom/liulishuo/filedownloader/download/ConnectTask;Lcom/liulishuo/filedownloader/connection/FileDownloadConnection;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method inspectTaskModelResumeAvailableOnDB(Ljava/util/List;)V
    ...
    .line 441
    iget-boolean p1, p0, Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable;->isResumeAvailableOnDB:Z
...
.method public run()V
    ...
    .line 264
    iget-boolean v4, p0, Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable;->paused:Z
    ...
    .catch Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable$DiscardSafely; {:try_start_4 .. :try_end_4} :catch_6
    .catch Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable$RetryDirectly; {:try_start_4 .. :try_end_4} :catch_5
    ...
    invoke-direct {p0, v4, v5, v6}, Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable;->handlePreAllocate(JLjava/lang/String;)V

    .line 275
    invoke-direct {p0, v4, v5}, Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable;->calcConnectionCount(J)I
    ...
    .catch Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable$DiscardSafely; {:try_start_6 .. :try_end_6} :catch_6
    .catch Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable$RetryDirectly; {:try_start_6 .. :try_end_6} :catch_5
    ...
    :cond_f
    :try_start_8
    iget-boolean v7, p0, Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable;->paused:Z
    ...
    .catch Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable$DiscardSafely; {:try_start_8 .. :try_end_8} :catch_6
    .catch Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable$RetryDirectly; {:try_start_8 .. :try_end_8} :catch_5
    ...
    :goto_7
    :try_start_a
    iput-boolean v7, p0, Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable;->isSingleConnection:Z

    .line 293
    iget-boolean v7, p0, Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable;->isSingleConnection:Z

    if-eqz v7, :cond_14

    .line 295
    invoke-direct {p0, v4, v5}, Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable;->realDownloadWithSingleConnection(J)V

    goto :goto_9

    .line 298
    :cond_14
    iget-object v7, p0, Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable;->statusCallback:Lcom/liulishuo/filedownloader/download/DownloadStatusCallback;

    invoke-virtual {v7}, Lcom/liulishuo/filedownloader/download/DownloadStatusCallback;->onMultiConnection()V

    .line 299
    iget-boolean v7, p0, Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable;->isResumeAvailableOnDB:Z

    if-eqz v7, :cond_15

    .line 300
    invoke-direct {p0, v6, v0}, Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable;->realDownloadWithMultiConnectionFromResume(ILjava/util/List;)V

    goto :goto_9

    .line 303
    :cond_15
    invoke-direct {p0, v4, v5, v6}, Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable;->realDownloadWithMultiConnectionFromBeginning(JI)V
    ...
    .catch Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable$DiscardSafely; {:try_start_a .. :try_end_a} :catch_6
    .catch Lcom/liulishuo/filedownloader/download/DownloadLaunchRunnable$RetryDirectly; {:try_start_a .. :try_end_a} :catch_5
