...
public class MediaPlayer {
    ...
    private final ILibVLC mILibVLC = new LibVLC(null);
    private org.videolan.libvlc.MediaPlayer mMediaPlayer = new org.videolan.libvlc.MediaPlayer(this.mILibVLC);
    ...
    public void setDataSource(Context context, Uri uri, Map<String, String> map) throws IOException, IllegalArgumentException, SecurityException, IllegalStateException {
        this.mCurrentMedia = new Media(this.mILibVLC, uri);
        this.mMediaPlayer.setMedia(this.mCurrentMedia);
    }

    public void setDataSource(String str) throws IOException, IllegalArgumentException, SecurityException, IllegalStateException {
        this.mCurrentMedia = new Media(this.mILibVLC, str);
        this.mMediaPlayer.setMedia(this.mCurrentMedia);
    }

    public void setDataSource(FileDescriptor fileDescriptor) throws IOException, IllegalArgumentException, IllegalStateException {
        this.mCurrentMedia = new Media(this.mILibVLC, fileDescriptor);
        this.mMediaPlayer.setMedia(this.mCurrentMedia);
    }
