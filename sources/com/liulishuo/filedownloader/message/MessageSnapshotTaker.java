    ...
    public static MessageSnapshot take(byte b, FileDownloadModel fileDownloadModel, DownloadStatusCallback.ProcessParams processParams) {
        ...
        switch (b) {
            ...
            default:
                ...
                if (fileDownloadModel.isLargeFile()) {
                    errorMessageSnapshot = new LargeMessageSnapshot.ErrorMessageSnapshot(id, fileDownloadModel.getSoFar(), illegalStateException);
                } else {
                    errorMessageSnapshot = new SmallMessageSnapshot.ErrorMessageSnapshot(id, (int) fileDownloadModel.getSoFar(), illegalStateException);
                }
                return errorMessageSnapshot;
            case -1:
                if (fileDownloadModel.isLargeFile()) {
                    return new LargeMessageSnapshot.ErrorMessageSnapshot(id, fileDownloadModel.getSoFar(), processParams.getException());
                }
            ...
            case 5:
                if (fileDownloadModel.isLargeFile()) {
                    return new LargeMessageSnapshot.RetryMessageSnapshot(id, fileDownloadModel.getSoFar(), processParams.getException(), processParams.getRetryingTimes());
                }
                return new SmallMessageSnapshot.RetryMessageSnapshot(id, (int) fileDownloadModel.getSoFar(), processParams.getException(), processParams.getRetryingTimes());
            case 6:
