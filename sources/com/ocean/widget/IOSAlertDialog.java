...
public class IOSAlertDialog {
    ...
    public IOSAlertDialog setPositiveButton(String str, final View.OnClickListener onClickListener) {
        ...
        this.btn_pos.setOnClickListener(new View.OnClickListener() { // from class: com.ocean.widget.IOSAlertDialog.1
    ...
    public IOSAlertDialog setNegativeButton(String str, final View.OnClickListener onClickListener) {
        ...
        this.btn_neg.setOnClickListener(new View.OnClickListener() { // from class: com.ocean.widget.IOSAlertDialog.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                onClickListener.onClick(view);
                IOSAlertDialog.this.dialog.dismiss();
    ...
    private void setLayout() {
        ...
        if (!this.showPosBtn && !this.showNegBtn) {
            ...
            this.btn_pos.setOnClickListener(new View.OnClickListener() { // from class: com.ocean.widget.IOSAlertDialog.3
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    IOSAlertDialog.this.dialog.dismiss();
                }
