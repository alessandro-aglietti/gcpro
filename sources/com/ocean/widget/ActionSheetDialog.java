...
public class ActionSheetDialog {
    ...
    public ActionSheetDialog builder() {
        ...
        this.txt_cancel.setOnClickListener(new View.OnClickListener() { // from class: com.ocean.widget.ActionSheetDialog.1
    ...
    private void setSheetItems() {
        ...
        for (final int i = 1; i <= size; i++) {
            ...
            textView.setOnClickListener(new View.OnClickListener() { // from class: com.ocean.widget.ActionSheetDialog.2
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
